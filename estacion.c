...
typedef struct {
    ...
    pthread_mutex_t mutex_nafta; // crea el candado del mutex de nafta
    pthread_mutex_t mutex_oxigeno; // crea el candado del mutex de oxígeno
} EstadoYPF;
...
int main()
{
    ...
    // desarma el candado del mutex e invalida la variable
