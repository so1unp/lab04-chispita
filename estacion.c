...
//mas dificil pero se puede hacer con memoria comoartida donde las naves van a escribir baja un mutex toma el combustible e incrementa y suleta la memoria 
    initscr();
    noecho();
    cbreak();
    ...
    while (1)
    {
        ...
        mvwprintw(ventana, 16, 2, "Combustible: EN YPF %d",combustible);
        ...
        {
            //menu 
            mvwprintw(ventana, 21, 2,"[1] 5 Deuterio -> 10 Combustible");
            ...
            mvwprintw(ventana, 26,2,"combustible jugador: %d", combustible_jugador);
        }else{
            ...
            switch(tecla)
            {
               ...
               case '1':
                        if (deuterio >= 5){
                            ...
                            combustible -= 10;
                            recolector1++;
                            combustible_jugador += 10;

                            if (combustible == 0 ){
                                mvwprintw(ventana, 16, 2, "Combustible: %d  ", combustible);
                                mvwprintw(ventana, 20, 2, " NO HAY COMBUSTIBLE Reponiendo... ");
                                wrefresh(ventana);
                                sleep(1);


                                if (combustible == 0 && recolector1 >=  1){
                                    combustible =100;
                                    recolector1-- ;
                                }
                            }
